/**
 * JUnit test class for the Queen class.
 */
...
public class QueenTest {
  ...
  /**
   * Tests the getters of the Queen class.
   */
  @Test(timeout = 500)
  ...
  /**
   * Tests invalid constructions of the Queen class.
   */
  @Test(timeout = 500)
  ...
  /**
   * Tests the move functionality of the Queen class.
   */
  @Test(timeout = 500)
  ...
  /**
   * Tests the kill functionality of the Queen class.
   */
  @Test(timeout = 500)

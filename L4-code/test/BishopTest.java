...
public class BishopTest {
  ...
  /**
   * Tests the getters of the Bishop class.
   */
  @Test(timeout = 500)
  ...
  /**
   * Tests invalid constructions of the Bishop class.
   */
  @Test(timeout = 500)
  ...
  /**
   * Tests the move functionality of the Bishop class.
   */
  @Test(timeout = 500)
  ...
  /**
   * Tests the kill functionality of the Bishop class.
   */
  @Test(timeout = 500)
